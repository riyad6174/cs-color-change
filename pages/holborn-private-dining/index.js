...
import Section1 from '@/components/HolbornPrivateDiningComponent/Section1';
import Section5 from '@/components/HolbornPrivateDiningComponent/Section5';
...
export default function Home() {
  return (
    <>
      <Head>
        <title>
          Exclusive Holborn Private Dining Experience | Colonel Saab
        </title>
        <meta
          name='description'
