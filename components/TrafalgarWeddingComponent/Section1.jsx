  ...
  return (
    ...
    >
      <div className='row text-center'>
        <h1 className='mt-3 text-success'>Trafalgar Square </h1>
        <h5 style={{ color: 'gray' }}>42 William IV St, Trafalgar Square</h5>
        <p className='text-center col-sm-10 offset-sm-1 col-lg-8 offset-lg-2 mt-3 mt-md-4'>
          ...
          for weddings, private dining, and celebratory events. Led by the
          esteemed restaurateur Roop Partap Choudhary, the venue is a
          celebration of Indian cuisine and heritage, offering a welcoming
          environment for guests. The venue is perfect for exclusive wedding
          receptions, private dining parties, corporate dining events, large
          group birthday bookings, and other celebratory occasions, with several
      ...
      <div className='d-flex align-items-center justify-content-center gap-2 gap-md-4'>
        ...
        <Link
          href='/trafalgarsquare-wedding-packages'
