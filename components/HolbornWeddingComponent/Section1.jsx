  ...
  return (
    ...
    >
      <div className='row text-center'>
        <h1 className='mt-3 text-success'>Holborn Town Hall</h1>
        <h5 style={{ color: 'gray' }}>
        ...
        <p className='text-center col-sm-10 offset-sm-1 col-lg-8 offset-lg-2 mt-md-4 mt-3'>
          ...
          the restaurant complement the old building with warm colors, brass and
          wood features, and a stunning collection of chandeliers handcrafted
          and shipped from India. In addition to the restaurant and bar, we have
          two tastefully designed private dining rooms, creating the ideal
          setting for weddings, corporate dining, or any celebratory event.
        </p>
      </div>
